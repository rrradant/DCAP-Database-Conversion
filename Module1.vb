...
Module Module1
    ...
    Sub Main()
        ...
        strGetStatIDListSQL = "SELECT * FROM [StatusIDList] WHERE (Converted = 0);"
    ...
    Public Sub ConvertStatus(ID As Long)
        ...
        strReadOrigSQL = "SELECT * FROM [Status_RST-XVI] Where (StatusID = @OrigStatusID);"
        ...
        strWriteStatusIDConverted = "UPDATE StatusIDList SET (Converted = 1) WHERE (StatusID = @OrigStatusID);"
        ...
        Try
            ...
            RecordCount = dbCmdWIDList.ExecuteScalar()
            'RecordCount = dbDA_Orig.Fill(dbDT_IDs)
            If RecordCount <> 1 Then
                Throw New Exception("Invalid RecordCount from initial dbDT_Orig datatable fill command.")
            End If
            'Clean up
